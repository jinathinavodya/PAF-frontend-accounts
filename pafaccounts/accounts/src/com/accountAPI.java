...
public class AccountAPI extends HttpServer {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = accObj.insertAccount(request.getParameter("userID"),      
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = accObj.updateAccount(paras.get("hidaccountIDSave").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request);
		String output = payObj.deleteAccount(paras.get("accountID").toString());
		response.getWriter().write(output);
	}
